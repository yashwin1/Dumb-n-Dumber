...
public class Option2_2a extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.option2_2a);
    ...
    public void level2_b(View view){
        Intent intent = new Intent(this, Level2_b.class);
