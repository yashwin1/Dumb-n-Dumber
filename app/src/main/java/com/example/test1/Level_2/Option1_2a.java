...
public class Option1_2a extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.option1_2a);
    ...
    public void level2_c(View view){
        Intent intent = new Intent(this, Level2_c.class);
