...
public class Option2_3d extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.option2_3d);
    ...
    public void level3_g(View view){
        Intent intent = new Intent(this, Level3_g.class);
