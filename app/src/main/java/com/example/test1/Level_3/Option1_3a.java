...
public class Option1_3a extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.option1_3a);
    ...
    public void level3_d(View view){
        Intent intent = new Intent(this, Level3_d.class);
