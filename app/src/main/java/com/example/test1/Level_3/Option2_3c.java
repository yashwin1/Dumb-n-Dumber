...
public class Option2_3c extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.option2_3c);
    ...
    public void level3_e(View view){
        Intent intent = new Intent(this, Level3_e.class);
