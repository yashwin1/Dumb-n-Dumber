...
public class Option3_3a extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.option3_3a);
    ...
    public void level3_b(View view){
        Intent intent = new Intent(this, Level3_b.class);
