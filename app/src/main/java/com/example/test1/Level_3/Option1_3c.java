...
public class Option1_3c extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.option1_3c);
    ...
    public void level3_f(View view){
        Intent intent = new Intent(this, Level3_f.class);
