...
public class Option2_3a extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.option2_3a);
    ...
    public void level3_c(View view){
        Intent intent = new Intent(this, Level3_c.class);
